...
class VcdReader : public IWaveformReader {
private:
    std::string filename;
    bool is_open;
    QSharedPointer<VcdHierarchy> vcd_hierarchy;
public:
    VcdReader();
    ~VcdReader();
    ...
    FileType get_file_type() const override { return FileType::VCD; }
...
private:
    ...
    void build_signal_data(Waveform& waveform);
};